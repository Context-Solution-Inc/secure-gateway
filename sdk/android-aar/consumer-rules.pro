...
-keep class com.contextsolutions.securegateway.core.SodiumProvider { *; }
-keep class * implements com.contextsolutions.securegateway.core.SodiumProvider { *; }
-keepclassmembers class * implements com.contextsolutions.securegateway.core.SodiumProvider {
    <init>();
}
